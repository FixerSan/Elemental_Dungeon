...
public class QuestInventoryUI : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        QuestDatabase.instance.onChangeCurrentQuest += RedrawQuest;
    }
    ...
    private void RedrawQuest()
    {
        ...
        for (int i = 0; i < QuestDatabase.instance.current_Quest.Count; i++)
        {
            slots[i].quest = QuestDatabase.instance.current_Quest[i];
